...
class Settings(BaseSettings):
    ...
    openclaw_gateway_max_concurrency: int = Field(default=10, alias="OPENCLAW_GATEWAY_MAX_CONCURRENCY")
    ...
    task_global_chat_concurrency: int = Field(default=10, alias="TASK_GLOBAL_CHAT_CONCURRENCY")
    task_per_conversation_concurrency: int = Field(default=5, alias="TASK_PER_CONVERSATION_CONCURRENCY")
    task_per_agent_concurrency: int = Field(default=10, alias="TASK_PER_AGENT_CONCURRENCY")
    task_per_user_concurrency: int = Field(default=10, alias="TASK_PER_USER_CONCURRENCY")
